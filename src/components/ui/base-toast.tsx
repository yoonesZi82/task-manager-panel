...
const toastTypeVariants = cva("rounded-lg text-sm", {
  variants: {
    type: {
      loading:
                  ...
                  return (
                    ...
                    >
                      {isCustomToast(toast) && toast.data ? (
                        ...
                        <div
                          className={cn(
                            "flex justify-between items-center gap-2 p-4 w-full",
                        ...
                        >
                          ...
                          {(toast.data?.close || showCloseButton) && (
                            <Toast.Close
                              className={cn(
                                "top-2 absolute [&_svg]:opacity-60 hover:[&_svg]:opacity-100 [&_svg]:size-3.5 cursor-pointer end-2"
                              )}
